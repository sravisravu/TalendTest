...
public class test implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LEARNING_test = new byte[0];
		static byte[] commonByteArray_LEARNING_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LEARNING_test.length) {
					if (length < 1024
							&& commonByteArray_LEARNING_test.length == 0) {
						commonByteArray_LEARNING_test = new byte[1024];
					} else {
						commonByteArray_LEARNING_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LEARNING_test, 0, length);
				strReturn = new String(commonByteArray_LEARNING_test, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LEARNING_test) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream(
							"learning/test_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 29499 characters generated by Talend Big Data Platform on the February 17,
 * 2017 12:34:42 PM CST
 ************************************************************************************************/
