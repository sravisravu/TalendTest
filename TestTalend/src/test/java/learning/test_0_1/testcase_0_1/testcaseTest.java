package learning.test_0_1.testcase_0_1;
...
/**
 * Job: testcaseTest Purpose: <br>
 * Description:  <br>
 * @author Mailavaram, Sravanthi
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class testcaseTest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "testcaseTest.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(testcaseTest.class);
	...
	private final String jobName = "testcase";
	private final String projectName = "LEARNING";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testcaseTest.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_LEARNING_testcase = new byte[0];
		static byte[] commonByteArray_LEARNING_testcase = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LEARNING_testcase.length) {
					if (length < 1024
							&& commonByteArray_LEARNING_testcase.length == 0) {
						commonByteArray_LEARNING_testcase = new byte[1024];
					} else {
						commonByteArray_LEARNING_testcase = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LEARNING_testcase, 0, length);
				strReturn = new String(commonByteArray_LEARNING_testcase, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LEARNING_testcase) {
	...
	public static void main(String[] args) {
		final testcaseTest testcaseTestClass = new testcaseTest();

		int exitCode = testcaseTestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'testcase' - Done.");
		}
	...
	public void testDefault() throws java.lang.Exception {
		...
		testcaseTestClass.runJobInTOS(arrays);
		...
		if (testcaseTestClass.exception != null) {
			throw testcaseTestClass.exception;
		}
	}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'testcase' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = testcaseTest.class.getClassLoader()
					.getResourceAsStream(
							"learning/test_0_1/testcase_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : testcaseTest");
		}
...
/************************************************************************************************
 * 55171 characters generated by Talend Big Data Platform on the February 17,
 * 2017 12:37:59 PM CST
 ************************************************************************************************/
